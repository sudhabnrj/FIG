...
export const Hero = async () => {
  ...
  return (
    <section className="h-[500px] md:h-[300px] border-b border-border-custom text-center relative overflow-hidden">
      ...
      <div className="container flex flex-col justify-center mx-auto bg-transparent absolute top-1/2 -translate-y-1/2 left-0 right-0 w-full h-full pointer-events-none select-none">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <div className="bg-white border border-border-custom rounded px-4 py-2 shadow-sm flex items-center gap-2">
            ...
            <span className="text-text-muted font-semibold text-[0.9rem]">
              Questions: <strong className="text-text-primary font-bold">{questions.length}</strong>
            </span>
          </div>
        </div>
      </div>
